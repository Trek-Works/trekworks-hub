...
const CACHE_NAME = `sp-2025-packing-${VERSION}`;
...
async function networkFirstNavigation(request) {
  ...
  try {
    ...
    cache.put('/SP-2025-packing/index.html', response.clone());
    return response;
  } catch (err) {
    const cached = await caches.match('/SP-2025-packing/index.html') ||
                   await caches.match('/SP-2025-packing/offline.html');
    return cached;
  }
}
